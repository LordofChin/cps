...
do
    ...
    do
        ...
        java FullKnapSack4Bash.java data/bash_inputs/bash_input_sample_number_$h/bash_input_at_items_count_of_$i.txt | grep "Total running time:" | grep -oE "[0-9.]+" >> bash_outputs/bash_output_sample_number_$h.txt
    done
